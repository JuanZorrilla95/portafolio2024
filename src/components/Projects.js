...
function Projects() {
  const projects = [
    ...
    { title: 'GYM Kumbia-PHP', description: 'Proyecto de un Gimnasio con alta de clases, profesores, horarios hecho con KumbiaPHP y el patrón MVC', <img src="/logogym.png" alt="Logo Gym" />
